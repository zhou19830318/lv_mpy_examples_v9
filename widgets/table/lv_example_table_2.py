...
def change_event_cb(e):
    ...
    if chk:
        ...
        table.set_cell_ctrl(row.uint_val, 0, lv.table.CELL_CTRL.CUSTOM_1)
...
t = ticks_ms()
print("ticks: ", t)
table = lv.table(lv.screen_active())

# Set a smaller height to the table. It'll make it scrollable
table.set_size(150, 200)

table.set_column_width(0, 150)
table.set_row_count(ITEM_CNT)  # Not required but avoids a lot of memory reallocation lv_table_set_set_value
...
table.add_event_cb(draw_event_cb, lv.EVENT.DRAW_TASK_ADDED, None)
