...
red_slider.set_value(lv.OPA._20, False)
green_slider.set_value(lv.OPA._90, False)
blue_slider.set_value(lv.OPA._60, False)
intense_slider.set_value(lv.OPA._50, False)
