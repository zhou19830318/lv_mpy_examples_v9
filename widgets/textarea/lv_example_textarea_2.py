...
#LV_HOR_RES = lv.screen_active().get_disp().driver.hor_res
#LV_VER_RES = lv.screen_active().get_disp().driver.ver_res

pwd_ta = lv.textarea(lv.screen_active())
pwd_ta.set_text("")
pwd_ta.set_password_mode(True)
pwd_ta.set_one_line(True)
pwd_ta.set_width(lv.pct(40))
pwd_ta.set_pos(5, 20)
