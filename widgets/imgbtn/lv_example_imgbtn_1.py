...
try:
    with open('./imgbtn_left.png','rb') as f:
...
try:
    with open('./imgbtn_mid.png','rb') as f:
...
try:
    with open('./imgbtn_right.png','rb') as f:
...
imgbtn1 = lv.imagebutton(lv.screen_active())
imgbtn1.set_src(lv.imagebutton.STATE.RELEASED, imgbtn_left_dsc, imgbtn_mid_dsc, imgbtn_right_dsc)
